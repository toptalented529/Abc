...
const RequireUneView = props => {
  ...
  const  handleContinue = () => {
    navigation.navigate("RequirePaymentView")
  }
      ...
      <ImageBackground style={styles.container} source={images.background}>
        ...
        <View style={styles.metamaskBox}>
          ...
          <View style={{ flex: 1, justifyContent: 'center' }}>
            <Text style={styles.metamaskText}>For the registration process</Text>
          </View>
          <View style={{ flex: 1, justifyContent: 'center',marginBottom: 15 }}>
            <Text style={styles.metamaskText}>you will need UNE Crypto, contact your sponser</Text>
          </View>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(RequireUneView));
