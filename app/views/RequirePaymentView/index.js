...
const RequirePaymentView = props => {
      ...
      <ImageBackground style={styles.container} source={images.background}>
        ...
        <View style={styles.metamaskBox}>
          ...
          <View style={{ flex: 1, justifyContent: 'center' }}>
            <Text style={styles.metamaskText}>To use the Universe Mobile Office</Text>
          </View>
          <View style={{ flex: 1, justifyContent: 'center',marginBottom: 15 }}>
            <Text style={styles.metamaskText}>a payment of 15usd is required</Text>
          </View>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(RequirePaymentView));
